...
const NextMeeting = (props) => {
  ...
  return (
    ...
    <div className='bookClubNextMeeting'>
          ...
          <p className='bookClubNextMeetingText'>{bookClub.meetings.nextMeetingDate}</p>
          <p className='bookClubNextMeetingTitle'>Time:</p>
          <p className='bookClubNextMeetingText'>{bookClub.meetings.nextMeetingTime}</p>
          {/* Add formatting for address object */}
          <p className='bookClubNextMeetingTitle'>Location:</p>
          <p className='bookClubNextMeetingText'>{bookClub.meetings.nextMeetingLocation?.online}</p>
        </div>
    </>
  )
}
